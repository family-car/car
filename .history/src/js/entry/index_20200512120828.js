    ...
    var  process={
        ...
        footerTab:function(){
            ...
            $(".weui-tabbar .weui-tabbar__item").on("click",function(){
                ...
                $(this).children(".weui-tabbar__label")
                               .addClass("active")
                               .parent()
                               .siblings()
                               .children(".weui-tabbar__label")
                               .removeClass("active")
               console.log( $(this).children(".weui-tabbar__label")
               .addClass("active").parent()
               .siblings().find(".weui-tabbar__label").html())
               /*  _this.activeSrc.forEach((item, index) => {
                    if(index==listIndex){
                        $(this).children(".weui-tabbar__icon")
                               .find("img")
                               .attr("src",item.url)
                    }
                }) */
